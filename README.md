# Frontend Mentor - Componente principal do cartão de perfil

Esta é uma solução para o desafio do Frontend Mentor [Profile card component](https://www.frontendmentor.io/challenges/profile-card-component-cfArpWshJ). Os desafios do Frontend Mentor ajudam a melhorar minhas habilidades de codificação criando projetos realistas.
...
- URL da solução: [Github](https://github.com/BraynnerM/Cartao-de-perfil)
-  URL do site no Github Pages: [Cartão-NFT](https://braynnerm.github.io/Cartao-de-perfil/)
